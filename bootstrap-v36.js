(() => {
  ...
  function baseUrl() {
    const s = [...document.querySelectorAll('script[src]')].find(e => String(e.src).includes('/answer-me-/bootstrap-v36.js'));
  ...
  async function boot() {
    ...
    console.log(`[💢 Answer Me] wrapper ${VERSION} ready · whole settings fold restored`);
  }
