(() => {
    ...
    function baseUrl() {
        const script = [...document.querySelectorAll('script[src]')]
            .find(el => String(el.src).includes('/answer-me-/bootstrap-v19.js'));
    ...
    async function boot() {
        ...
        await inject('compact-ui-v19.js', 'compact-ui-v19');
        ...
        console.log(`[💢 Answer Me] wrapper ${VERSION} ready · compact control deck loaded`);
    }
