(() => {
  ...
  function baseUrl(){const s=[...document.querySelectorAll('script[src]')].find(e=>String(e.src).includes('/answer-me-/bootstrap-v31.js'));return s?.src?new URL('.',s.src):new URL('/scripts/extensions/third-party/answer-me-/',window.location.origin)}
  ...
  async function boot(){
    ...
    await inject('safety-watchdog-v31.js','safety-watchdog-v31');
    ...
    console.log(`[💢 Answer Me] wrapper ${VERSION} ready · safety watchdog armed; soft-settle removed`);
  }
