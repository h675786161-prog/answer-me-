(() => {
    ...
    function baseUrl() {
        const script = [...document.querySelectorAll('script[src]')]
            .find(el => String(el.src).includes('/answer-me-/bootstrap-v14.js'));
    ...
    async function boot() {
        // v13 负责扫每家站的 /models + 假流请求包装；v14 在目录层把真流/假流彻底拆开。
        ...
        console.log(`[💢 Answer Me] wrapper ${VERSION} ready · transport-aware model catalog loaded`);
    }
