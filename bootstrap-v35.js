(() => {
  ...
  function baseUrl() {
    const s = [...document.querySelectorAll('script[src]')].find(e => String(e.src).includes('/answer-me-/bootstrap-v35.js'));
  ...
  async function boot() {
    ...
    console.log(`[💢 Answer Me] wrapper ${VERSION} ready · relaxed stream start + single API retry`);
  }
