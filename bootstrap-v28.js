(() => {
  ...
  function baseUrl(){const s=[...document.querySelectorAll('script[src]')].find(e=>String(e.src).includes('/answer-me-/bootstrap-v28.js'));return s?.src?new URL('.',s.src):new URL('/scripts/extensions/third-party/answer-me-/',window.location.origin)}
  ...
  async function boot(){
    ...
    await inject('popup-close-v28.js','popup-close-v28');
    ...
    console.log(`[💢 Answer Me] wrapper ${VERSION} ready · filtered diagnostics + side fallback + sticky popup close`);
  }
