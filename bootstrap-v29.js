(() => {
  ...
  function baseUrl(){const s=[...document.querySelectorAll('script[src]')].find(e=>String(e.src).includes('/answer-me-/bootstrap-v29.js'));return s?.src?new URL('.',s.src):new URL('/scripts/extensions/third-party/answer-me-/',window.location.origin)}
  ...
  async function boot(){
    ...
    await inject('popup-close-v29.js','popup-close-v29');
    ...
    console.log(`[💢 Answer Me] wrapper ${VERSION} ready · mobile popup close fixed`);
  }
