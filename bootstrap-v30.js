(() => {
  ...
  function baseUrl(){const s=[...document.querySelectorAll('script[src]')].find(e=>String(e.src).includes('/answer-me-/bootstrap-v30.js'));return s?.src?new URL('.',s.src):new URL('/scripts/extensions/third-party/answer-me-/',window.location.origin)}
  ...
  async function boot(){
    ...
    console.log(`[💢 Answer Me] wrapper ${VERSION} ready · popup observers removed, panel nonblocking`);
  }
