(() => {
    ...
    function baseUrl() {
        const script = [...document.querySelectorAll('script[src]')]
            .find(el => String(el.src).includes('/answer-me-/bootstrap-v15.js'));
    ...
    async function boot() {
        ...
        await inject('transport-catalog-v14.js', 'transport-catalog-v14');
        await inject('site-selector-v15.js', 'site-selector-v15');
        ...
        console.log(`[💢 Answer Me] wrapper ${VERSION} ready · transport-aware catalog + site selector loaded`);
    }
